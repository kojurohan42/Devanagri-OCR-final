...
def stringInterpolate(coreMod,upperMod=10):
    ...
    if coreMod == 68:
        ...
        if coreMod == 33:
            ...
            return [core_modifiers[coreMod-42]]+ res
        elif 46 < coreMod < 50:
        ...
        if coreMod == 33:
            ...
            return [core_modifiers[coreMod-42],0x094D]
        elif coreMod == 46:
            return [core_modifiers[coreMod-41],0x094D]
        elif 46 < coreMod < 50:
            return [core_modifiers[coreMod-40],0x094D]
        elif  50 <= coreMod <= 52:
            return [core_modifiers[coreMod-36],0x094D]
        elif  53 <= coreMod <= 62:
            return [core_modifiers[coreMod-35],0x094D]
        elif  63 <= coreMod <= 67:
            return [core_modifiers[coreMod-34],0x094D]
        else:
            return []
    else:
        return []
